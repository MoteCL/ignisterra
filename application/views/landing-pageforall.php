                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav  navbar-right ">
                        <li class="dropdown profile">
                            <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button" aria-expanded="false"><img src="<?php echo base_url('assets/img/default.png'); ?>" class="profile-img"> <span class="caret"></span></a>
