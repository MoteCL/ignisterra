                    ...
                    <div class="navbar-header">
                        ...
                        <ol class="breadcrumb hidden-xs">
                            ...
                            <li class="">
                                ...
                                <a href="<?php echo base_url('index.php/mantencion/listByArea'); ?>" target="_self" style="color:">Listado</a>
                            </li>
                            <li class="active">
                                Autorizar
                            </li>
            ...
            <div class="container-fluid">
                ...
                <div class="side-body padding-top">
                    ...
                    <h1 class="page-title">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo base_url('index.php/mantencion/listByArea');  ?>" class="btn btn-warning">
