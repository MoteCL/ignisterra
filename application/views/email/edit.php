                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="http://www.ignisterra.cl/img/logofull.png" alt="" /></a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                              ...
                              <span style="color: rgb(254, 55, 55);">Se ha modificado una Mantencion </span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <strong></strong>
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                           Han modificado una mantecion con codigo <strong><?php echo $NroSolicitud; ?></strong>. Realizada por el Supervisor  <em><?php echo $Nombre; ?></em> codigo <strong><?php echo $Codigo; ?></strong>
                                            Area <strong><?php echo $Area; ?></strong>  .
                                        </p>
                                        <h3>Maquina</h3>
                                        <br>
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                          <?php $hoy = date('Y-m-d');  ?>
                                            Mantencion ingresada fecha  <?php echo date('j M Y',strtotime($fechasolicitud));; ?>.
                                        </p>
                                        <hr>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                          <?php $hoy = date('Y-m-d'); ?>
                                            Modificacion realiza  <?php echo date('j M Y',strtotime($hoy));?>, modicando estado de URGENTE a
                                            <?php if ($urgente=='SI'): ?>
                                              <span style="color: rgb(254, 55, 55);"><?php echo $urgente; ?></span>
                                            <?php endif; ?>
                                            <?php if ($urgente=='NO'): ?>
                                                <span style="color:rgb(55, 246, 17);"><?php echo $urgente; ?></span>
                                            <?php endif; ?>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="http://www.ignisterra.cl/img/logofull.png" alt="" /></a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@email.com</a>
